...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView mcreatenew,mforget;
    ...
    private void initializefields() {
        mailedit = (EditText)findViewById(R.id.atvEmailLog);
        passedit = (EditText)findViewById(R.id.atvPasswordLog);
        mcreatenew= (TextView)findViewById(R.id.tvSignIn);
        mforget = (TextView)findViewById(R.id.tvForgotPass);
        logbtn = (Button)findViewById(R.id.btnSignIn);
        twitter = (ImageView)findViewById(R.id.ivFacebook);
